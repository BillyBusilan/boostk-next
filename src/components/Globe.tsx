...
// Placeholder for the Earth Texture Base64. 
// You should replace this with the actual base64 string from your texture.js file
// or use a high-quality Earth texture URL.
const earthTextureBase64 = "https://raw.githubusercontent.com/mrdoob/three.js/master/examples/textures/planets/earth_atmos_2048.jpg";
...
export default function Globe() {
    ...
    useEffect(() => {
        ...
        const earthTexture = textureLoader.load(earthTextureBase64);
        ...
        // --- Floating Text ---
        const greetings = [
            "Hello", "Bonjour", "Hola", "Ciao", "Hallo", "Olá", "Привет", "您好", "こんにちは", "안녕하세요",
            "Namaste", "Salam", "Merhaba", "Sawasdee", "Xin chào"
        ];
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
        const floatingTexts: any[] = []; // Using any for sprite with custom userData
        ...
        const spawnFloatingText = () => {
            ...
            const phi_rnd = Math.acos(2 * Math.random() - 1); // Corrected Uniform distribution
        ...
        const animate = () => {
            ...
            if (intersections.length > 0) {
                ...
                // Note: Accessing buffer attribute array directly
                const starsPosAttr = stars.geometry.attributes.position;
                const positions = starsPosAttr.array;
                let visibleCount = 0;

                // We need to iterate through the buffer array
        ...
        return () => {
            ...
            // Dispose geometries and materials if necessary to avoid memory leaks
            geometry.dispose();
            material.dispose();
